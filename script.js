...
const isAdultPresent = devs.some((dev) => {
    return dev.year <= 2005 //this works but would have to be updated each year. I wonder if it's possible to make this more sustainable by pulling today's date and doing a boolean comparison?
})
...
//! I found this wording confusing - I guess in this case I'm using an arrow function rather than a callback function but I think the question wanted us to have defined a separate function first and then call it through? Is it possible to see how this would look? I attempted it but couldn't get it to work!
